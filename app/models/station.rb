class Station < ApplicationRecord
	...
	if (:latitude != nil)&&(:longitude != nil)
		#na perasw sto station controller sto create tis parametrous na kanw to geocode ekei kai na to bgalw apo edw
		#results = Geocoder.search([39.63835396754601, 20.84018430120534])
		...
		reverse_geocoded_by :latitude, :longitude,
	  	...
	  	#puts results.first.address gia th dieu8unsh
	  	#data=JSON.parse(results)
	  	#puts data["address_components"]["long_name"]["types"]
